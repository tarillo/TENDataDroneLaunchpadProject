...
//         vector<vector<pair<double,double>>> IndividualClusters;
...
//     vector<vector<pair<double,double>>> getIndividualClusterSet();
     
//     void kMeansClustering();

// };   

// vector<vector<pair<double,double>>> k_means::getIndividualClusterSet() {
